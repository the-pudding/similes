...
<div class="c swarm" bind:this={el}>
	<div class="legend">
	...
	<div class="annotation top">Specialists &uarr;</div>
	<div class="chart">
		{#if data.length}
			<Plot
				{height}
			...
			>
				<Dot
					...
					x={0}
					{r}
					dodgeX={{ anchor: "middle", padding: 5 }}
	...
	<div class="annotation bottom">&darr; Generalists</div>
