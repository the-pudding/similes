import"../chunks/DsnmJJEf.js";import{aq as m,$ as d,a1 as M,t as _,K as l,a0 as u,ar as L,Z as E,F as C,_ as B,a2 as $,M as q,aH as N,ag as A,bb as Y,L as Q}from"../chunks/B92FeS2C.js";import{b as v,f,c as F,t as Z}from"../chunks/BvRfo2l_.js";import{a as w,f as X,e as J}from"../chunks/BwpuD7DB.js";import{e as H,i as z,c as ee,d as te}from"../chunks/C2Vtx1Y2.js";import{e as ne}from"../chunks/DD47trRG.js";import{c as ae,b as se,i as oe}from"../chunks/DxeqRFj7.js";import{s as re,p as j}from"../chunks/C2wkIQ8G.js";import{s as P}from"../chunks/DGiPyN0h.js";import{c as ie,C as le,a as ce}from"../chunks/X2ME0utI.js";import{b as he}from"../chunks/pPBJ8RY-.js";import"../chunks/HvopnIf4.js";var ue=f('<section id="demo-link"><h2>Link</h2> <p><a href="elements">Default element styles demo</a></p> <p><a href="fonts">Pudding-hosted font previews</a></p> <p><a href="ui">BitsUI styled components</a></p></section>');function pe(r){var t=ue();v(r,t)}var de=f('<section id="demo-image"><h2>Image</h2> <p>img tag</p> <img src="../assets/demo/test.jpg" alt="cat" class="svelte-b56t42"/> <p>background image</p> <div class="svelte-b56t42"></div></section>');function me(r){var t=de();v(r,t)}var ve=f('<section id="demo-element"><h2>Dynamic Svelte Element</h2> <!></section>');function ge(r){const t=[{tag:"h3",text:"I am a h3 tag."},{tag:"p",text:"I am p tag."}];var n=ve(),e=m(d(n),2);H(e,17,()=>t,z,(i,s)=>{let c=()=>l(s).tag,p=()=>l(s).text;var g=F(),a=M(g);ne(a,c,!1,(o,h)=>{var y=Z();_(()=>w(y,p())),v(h,y)}),v(i,g)}),u(n),v(r,n)}var fe=f("<p> </p>");function ye(r,t){var n=fe(),e=d(n);u(n),_(()=>w(e,`I am component A and my favorite number is ${t.number??""}.`)),v(r,n)}var be=f("<p> </p>");function we(r,t){var n=be(),e=d(n);u(n),_(()=>w(e,`I am component B and my name is ${t.name??""}.`)),v(r,n)}var xe=f('<section id="demo-component"><h2>Dynamic Svelte Component</h2> <!></section>');function ke(r){const t={A:ye,B:we},n=[{component:"A",number:42},{component:"B",name:"Russell"}];var e=xe(),i=m(d(e),2);H(i,17,()=>n,z,(s,c)=>{const p=L(()=>t[l(c).component]);var g=F(),a=M(g);ae(a,()=>l(p),(o,h)=>{h(o,re(()=>l(c)))}),v(s,g)}),u(e),v(r,e)}var _e=f("<div><!></div>");function Ie(r,t){E(t,!0);let n=j(t,"root",3,null),e=j(t,"top",3,0),i=j(t,"bottom",3,0),s=j(t,"increments",3,100),c=j(t,"value",15,void 0),p=[],g=[],a=[],o=[],h;function y(){let b=0,k=0;for(let S=0;S<p.length;S++)p[S]>b&&(b=p[S],k=S);b>0?c(k):c(void 0)}function I(b,k){const S=O=>{O[0].isIntersecting;const K=O[0].intersectionRatio;p[k]=K,y()},R=e()?e()*-1:0,V=i()?i()*-1:0,W=`${R}px 0px ${V}px 0px`,U={root:n(),rootMargin:W,threshold:g};o[k]&&o[k].disconnect();const G=new IntersectionObserver(S,U);G.observe(b),o[k]=G}function T(){a.length&&a.forEach(I)}C(()=>{for(let b=0;b<s()+1;b++)g.push(b/s());a=h.querySelectorAll(":scope > *:not(iframe)"),T()}),C(()=>{e(),i(),T()});var x=_e(),D=d(x);P(D,()=>t.children??$),u(x),se(x,b=>h=b,()=>h),v(r,x),B()}var Se=f('<div><p class="svelte-1sxgmm9"> </p></div>'),qe=f('<section id="scrolly"><h2 class="svelte-1sxgmm9">Scrolly <span> </span></h2> <div class="spacer svelte-1sxgmm9"></div> <!> <div class="spacer svelte-1sxgmm9"></div></section>');function Te(r){let t=A(void 0);var n=qe(),e=d(n),i=m(d(e)),s=d(i,!0);u(i),u(e);var c=m(e,4);Ie(c,{get value(){return l(t)},set value(p){q(t,p,!0)},children:(p,g)=>{var a=F(),o=M(a);H(o,16,()=>[0,1,2,3,4],z,(h,y,I)=>{const T=L(()=>l(t)===I);var x=Se();let D;var b=d(x),k=d(b,!0);u(b),u(x),_(()=>{D=ee(x,1,"step svelte-1sxgmm9",null,D,{active:l(T)}),w(k,y)}),v(h,x)}),v(p,a)},$$slots:{default:!0}}),N(2),u(n),_(()=>w(s,l(t)||"-")),v(r,n)}const je=`{
  "meta": {
...
}`;var Ae=f('<p> </p> <progress max="100"></progress>',1);function De(r,t){let n=j(t,"label",3,"A"),e=j(t,"value",3,0);var i=Ae(),s=M(i),c=d(s,!0);u(s);var p=m(s,2);_(()=>{w(c,n()),te(p,e())}),v(r,i)}var Me=f('<section id="cms"><h2>MicroCMS</h2> <code><pre> </pre></code> <!></section>');function Ce(r,t){E(t,!0);const{body:n}=ie,e={Test:De};var i=Me(),s=m(d(i),2),c=d(s),p=d(c,!0);u(c),u(s);var g=m(s,2);le(g,{get components(){return e},get body(){return n}}),u(i),_(a=>w(p,a),[()=>je.replace(/\t/g," ")]),v(r,i),B()}const Le=(r,t=$)=>{var n=Ee(),e=d(n),i=d(e,!0);u(e);var s=m(e,2),c=d(s,!0);u(s),u(n),_(()=>{w(i,t().name),w(c,t().age)}),v(r,n)};var Ee=f('<div class="person svelte-q3gttf"><p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p></div>'),Be=f('<h2>Svelte5</h2> <h3>Reactive variables 3 ways:</h3> <button class="svelte-q3gttf">count++</button> <p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p> <h3>Children (previously slots):</h3> <div class="children"><!></div> <h3>Dispatch Event</h3> <button class="svelte-q3gttf">Random</button>  <h3>Snippets</h3> <div class="people svelte-q3gttf"></div>',1);function He(r,t){E(t,!0),j(t,"age",3,30);const n=[{name:"John",age:30},{name:"Jill",age:45}];let e=A(0),i=L(()=>l(e)*2),s=L(()=>l(e)*2),c=A(0);C(()=>{q(c,l(e)*2)});var p=Be(),g=m(M(p),4),a=m(g,2),o=d(a);u(a);var h=m(a,2),y=d(h);u(h);var I=m(h,2),T=d(I);u(I);var x=m(I,4),D=d(x);P(D,()=>t.children??$),u(x);var b=m(x,4),k=m(b,4);H(k,21,()=>n,z,(S,R)=>{Le(S,()=>l(R))}),u(k),_(()=>{w(o,`${l(e)??""} doubled is ${l(i)??""} (derived)`),w(y,`${l(e)??""} doubled is ${l(s)??""} (derived by)`),w(T,`${l(e)??""} doubled is ${l(c)??""} ($effect)`)}),J("click",g,()=>Y(e)),J("click",b,()=>t.random(Math.floor(Math.random()*10))),v(r,p),B()}X(["click"]);const ze=(r,t)=>{let n=A(Q(r)),e=A(null),i=A(!0),s=A(void 0);const c=(a=!0)=>{q(i,a,!0),a===!0&&(q(s,null),q(e,null))},p=async()=>{try{const a=await fetch(l(n),t);if(!a.ok)throw new Error(`Unexpected error occurred (status ${a.status})`);let o;if(l(n).includes(".csv")){const h=await a.text();o=ce(h)}else o=await a.json();return[null,o]}catch(a){const{errorMessage:o="Unexpected error eccurred"}=a;return[o,null]}},g=async a=>{c(!0);const[o,h]=await p();if(a===l(n)){if(o){c(!1),q(s,o,!0);return}c(!1),q(e,h,!0)}};return C(()=>{g(l(n))}),{get data(){return l(e)},get loading(){return l(i)},get error(){return l(s)},get url(){return l(n)},set url(a){l(n)!==a&&q(n,a,!0)}}};var Re=f("<p>loading data...</p>"),$e=f("<p> </p>"),Fe=f("<p>data loaded</p> <pre> </pre>",1),Ge=f('<div class="c"><h2>Load Data</h2> <div class="response"><!></div></div>');function Oe(r,t){E(t,!0);const n=`${he}/assets/demo/test.csv`,e=ze(n);C(()=>{});var i=Ge(),s=m(d(i),2),c=d(s);{var p=o=>{var h=Re();v(o,h)},g=o=>{var h=$e(),y=d(h);u(h),_(()=>w(y,`error: ${e.error??""}`)),v(o,h)},a=o=>{var h=Fe(),y=m(M(h),2),I=d(y,!0);u(y),_(T=>w(I,T),[()=>JSON.stringify(e.data,null,2)]),v(o,h)};oe(c,o=>{e.loading?o(p):e.error?o(g,1):o(a,-1)})}u(s),u(i),v(r,i),B()}var Je=f('<div id="demo" class="svelte-15aotx7"><h1>Demo</h1> <!> <!> <!> <!> <!> <!> <!> <!></div>');function Pe(r){let t=A(0);function n(y){console.log(y)}var e=Je(),i=m(d(e),2);pe(i);var s=m(i,2);me(s);var c=m(s,2);ge(c);var p=m(c,2);ke(p);var g=m(p,2);Ce(g,{});var a=m(g,2);Oe(a,{});var o=m(a,2);Te(o);var h=m(o,2);He(h,{random:n,get value(){return l(t)},set value(y){q(t,y,!0)}}),u(e),v(r,e)}function at(r){Pe(r)}export{at as component};
