import"../chunks/DsnmJJEf.js";import{aq as m,$ as p,a1 as M,t as _,K as l,a0 as u,ar as L,Z as B,F as D,_ as E,a2 as R,M as q,aH as K,ag as A,bb as Y,L as Q}from"../chunks/B92FeS2C.js";import{b as v,f,c as $,t as Z}from"../chunks/BvRfo2l_.js";import{a as w,f as X,e as P}from"../chunks/BwpuD7DB.js";import{e as z,i as F,c as ee,d as te}from"../chunks/C2Vtx1Y2.js";import{e as ne}from"../chunks/DD47trRG.js";import{c as ae,b as se,i as oe}from"../chunks/DxeqRFj7.js";import{s as re,p as T}from"../chunks/C2wkIQ8G.js";import{s as J}from"../chunks/DGiPyN0h.js";import{c as ie,C as le,a as ce}from"../chunks/KPUBLXbF.js";import{b as he}from"../chunks/DyABxUGI.js";import"../chunks/HvopnIf4.js";var ue=f('<section id="demo-link"><h2>Link</h2> <p><a href="elements">Default element styles demo</a></p> <p><a href="fonts">Pudding-hosted font previews</a></p> <p><a href="ui">BitsUI styled components</a></p></section>');function de(r){var t=ue();v(r,t)}var pe=f('<section id="demo-image"><h2>Image</h2> <p>img tag</p> <img src="../assets/demo/test.jpg" alt="cat" class="svelte-b56t42"/> <p>background image</p> <div class="svelte-b56t42"></div></section>');function me(r){var t=pe();v(r,t)}var ve=f('<section id="demo-element"><h2>Dynamic Svelte Element</h2> <!></section>');function ge(r){const t=[{tag:"h3",text:"I am a h3 tag."},{tag:"p",text:"I am p tag."}];var n=ve(),e=m(p(n),2);z(e,17,()=>t,F,(i,s)=>{let c=()=>l(s).tag,d=()=>l(s).text;var g=$(),a=M(g);ne(a,c,!1,(o,h)=>{var y=Z();_(()=>w(y,d())),v(h,y)}),v(i,g)}),u(n),v(r,n)}var fe=f("<p> </p>");function ye(r,t){var n=fe(),e=p(n);u(n),_(()=>w(e,`I am component A and my favorite number is ${t.number??""}.`)),v(r,n)}var be=f("<p> </p>");function we(r,t){var n=be(),e=p(n);u(n),_(()=>w(e,`I am component B and my name is ${t.name??""}.`)),v(r,n)}var xe=f('<section id="demo-component"><h2>Dynamic Svelte Component</h2> <!></section>');function ke(r){const t={A:ye,B:we},n=[{component:"A",number:42},{component:"B",name:"Russell"}];var e=xe(),i=m(p(e),2);z(i,17,()=>n,F,(s,c)=>{const d=L(()=>t[l(c).component]);var g=$(),a=M(g);ae(a,()=>l(d),(o,h)=>{h(o,re(()=>l(c)))}),v(s,g)}),u(e),v(r,e)}var _e=f("<div><!></div>");function Ie(r,t){B(t,!0);let n=T(t,"root",3,null),e=T(t,"top",3,0),i=T(t,"bottom",3,0),s=T(t,"increments",3,100),c=T(t,"value",15,void 0),d=[],g=[],a=[],o=[],h;function y(){let b=0,k=0;for(let S=0;S<d.length;S++)d[S]>b&&(b=d[S],k=S);b>0?c(k):c(void 0)}function I(b,k){const S=O=>{O[0].isIntersecting;const U=O[0].intersectionRatio;d[k]=U,y()},H=e()?e()*-1:0,W=i()?i()*-1:0,V=`${H}px 0px ${W}px 0px`,N={root:n(),rootMargin:V,threshold:g};o[k]&&o[k].disconnect();const G=new IntersectionObserver(S,N);G.observe(b),o[k]=G}function j(){a.length&&a.forEach(I)}D(()=>{for(let b=0;b<s()+1;b++)g.push(b/s());a=h.querySelectorAll(":scope > *:not(iframe)"),j()}),D(()=>{e(),i(),j()});var x=_e(),C=p(x);J(C,()=>t.children??R),u(x),se(x,b=>h=b,()=>h),v(r,x),E()}var Se=f('<div><p class="svelte-1sxgmm9"> </p></div>'),qe=f('<section id="scrolly"><h2 class="svelte-1sxgmm9">Scrolly <span> </span></h2> <div class="spacer svelte-1sxgmm9"></div> <!> <div class="spacer svelte-1sxgmm9"></div></section>');function je(r){let t=A(void 0);var n=qe(),e=p(n),i=m(p(e)),s=p(i,!0);u(i),u(e);var c=m(e,4);Ie(c,{get value(){return l(t)},set value(d){q(t,d,!0)},children:(d,g)=>{var a=$(),o=M(a);z(o,16,()=>[0,1,2,3,4],F,(h,y,I)=>{const j=L(()=>l(t)===I);var x=Se();let C;var b=p(x),k=p(b,!0);u(b),u(x),_(()=>{C=ee(x,1,"step svelte-1sxgmm9",null,C,{active:l(j)}),w(k,y)}),v(h,x)}),v(d,a)},$$slots:{default:!0}}),K(2),u(n),_(()=>w(s,l(t)||"-")),v(r,n)}const Te=`{
  "meta": {
  ...
  "body": [
    ...
    },
    {
      ...
      "content": [
        ...
        {
          "type": "blockquote",
          "value": "“In the doorway stood Kristen, Dylan, and Alicia, looking <strong>as <span class=underline-ground-light>stunned</span> as <span class=underline-vehicle-light>Taylor Swift during the 2009 VMAs when Kanye stole her acceptance speech.</span></strong>”"
        },
        {
          "type": "text",
        ...
        {
          "type": "text",
          "value": "Plenty of these idioms have endured the test of time, like <strong>“as busy as a bee”</strong> or <strong>“fit as a fiddle,”</strong> though many have fallen out of fashion in recent decades, like <strong>“as drunk as a lord”</strong> or <strong>“as rich as Croesus.”</strong>"
        }
      ]
    },
    {
      ...
      "content": [
        ...
        {
          "type": "text",
          "value": "Most nouns land somewhere in the middle. Sometimes because they have some reliable pairings because of distinct qualities (e.g., glass is smooth, fragile, transparent) or because of conceptually similar adjectives (e.g., the sun is bright, brilliant, radiant)."
        },
        {
          "type": "text",
    ...
    },
    {
      ...
      "content": [
        ...
        {
          "type": "text",
          "value": "In fiction, a child has become shorthand for two things; being defenseless and wholesome. The scale tips towards the defenseless side with the highest usage being helpless and innocent."
        },
        {
          "type": "Child",
          "value": {}
        ...
        {
          "type": "text",
          "value": "Interestingly, child is still just second in usage in both of those adjectives to the even more defenseless baby."
        },
        {
          "type": "h3",
          "value": "Hell"
...
}`;var Ae=f('<p> </p> <progress max="100"></progress>',1);function Ce(r,t){let n=T(t,"label",3,"A"),e=T(t,"value",3,0);var i=Ae(),s=M(i),c=p(s,!0);u(s);var d=m(s,2);_(()=>{w(c,n()),te(d,e())}),v(r,i)}var Me=f('<section id="cms"><h2>MicroCMS</h2> <code><pre> </pre></code> <!></section>');function De(r,t){B(t,!0);const{body:n}=ie,e={Test:Ce};var i=Me(),s=m(p(i),2),c=p(s),d=p(c,!0);u(c),u(s);var g=m(s,2);le(g,{get components(){return e},get body(){return n}}),u(i),_(a=>w(d,a),[()=>Te.replace(/\t/g," ")]),v(r,i),E()}const Le=(r,t=R)=>{var n=Be(),e=p(n),i=p(e,!0);u(e);var s=m(e,2),c=p(s,!0);u(s),u(n),_(()=>{w(i,t().name),w(c,t().age)}),v(r,n)};var Be=f('<div class="person svelte-q3gttf"><p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p></div>'),Ee=f('<h2>Svelte5</h2> <h3>Reactive variables 3 ways:</h3> <button class="svelte-q3gttf">count++</button> <p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p> <h3>Children (previously slots):</h3> <div class="children"><!></div> <h3>Dispatch Event</h3> <button class="svelte-q3gttf">Random</button>  <h3>Snippets</h3> <div class="people svelte-q3gttf"></div>',1);function ze(r,t){B(t,!0),T(t,"age",3,30);const n=[{name:"John",age:30},{name:"Jill",age:45}];let e=A(0),i=L(()=>l(e)*2),s=L(()=>l(e)*2),c=A(0);D(()=>{q(c,l(e)*2)});var d=Ee(),g=m(M(d),4),a=m(g,2),o=p(a);u(a);var h=m(a,2),y=p(h);u(h);var I=m(h,2),j=p(I);u(I);var x=m(I,4),C=p(x);J(C,()=>t.children??R),u(x);var b=m(x,4),k=m(b,4);z(k,21,()=>n,F,(S,H)=>{Le(S,()=>l(H))}),u(k),_(()=>{w(o,`${l(e)??""} doubled is ${l(i)??""} (derived)`),w(y,`${l(e)??""} doubled is ${l(s)??""} (derived by)`),w(j,`${l(e)??""} doubled is ${l(c)??""} ($effect)`)}),P("click",g,()=>Y(e)),P("click",b,()=>t.random(Math.floor(Math.random()*10))),v(r,d),E()}X(["click"]);const Fe=(r,t)=>{let n=A(Q(r)),e=A(null),i=A(!0),s=A(void 0);const c=(a=!0)=>{q(i,a,!0),a===!0&&(q(s,null),q(e,null))},d=async()=>{try{const a=await fetch(l(n),t);if(!a.ok)throw new Error(`Unexpected error occurred (status ${a.status})`);let o;if(l(n).includes(".csv")){const h=await a.text();o=ce(h)}else o=await a.json();return[null,o]}catch(a){const{errorMessage:o="Unexpected error eccurred"}=a;return[o,null]}},g=async a=>{c(!0);const[o,h]=await d();if(a===l(n)){if(o){c(!1),q(s,o,!0);return}c(!1),q(e,h,!0)}};return D(()=>{g(l(n))}),{get data(){return l(e)},get loading(){return l(i)},get error(){return l(s)},get url(){return l(n)},set url(a){l(n)!==a&&q(n,a,!0)}}};var He=f("<p>loading data...</p>"),Re=f("<p> </p>"),$e=f("<p>data loaded</p> <pre> </pre>",1),Ge=f('<div class="c"><h2>Load Data</h2> <div class="response"><!></div></div>');function Oe(r,t){B(t,!0);const n=`${he}/assets/demo/test.csv`,e=Fe(n);D(()=>{});var i=Ge(),s=m(p(i),2),c=p(s);{var d=o=>{var h=He();v(o,h)},g=o=>{var h=Re(),y=p(h);u(h),_(()=>w(y,`error: ${e.error??""}`)),v(o,h)},a=o=>{var h=$e(),y=m(M(h),2),I=p(y,!0);u(y),_(j=>w(I,j),[()=>JSON.stringify(e.data,null,2)]),v(o,h)};oe(c,o=>{e.loading?o(d):e.error?o(g,1):o(a,-1)})}u(s),u(i),v(r,i),E()}var Pe=f('<div id="demo" class="svelte-15aotx7"><h1>Demo</h1> <!> <!> <!> <!> <!> <!> <!> <!></div>');function Je(r){let t=A(0);function n(y){console.log(y)}var e=Pe(),i=m(p(e),2);de(i);var s=m(i,2);me(s);var c=m(s,2);ge(c);var d=m(c,2);ke(d);var g=m(d,2);De(g,{});var a=m(g,2);Oe(a,{});var o=m(a,2);je(o);var h=m(o,2);ze(h,{random:n,get value(){return l(t)},set value(y){q(t,y,!0)}}),u(e),v(r,e)}function at(r){Je(r)}export{at as component};
