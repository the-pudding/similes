import"../chunks/DsnmJJEf.js";import{aq as m,Y as d,_ as D,t as _,G as l,Z as h,ar as B,W as L,ae as M,X as E,ab as O,J as q,aH as Y,ag as T,bb as K,I as Q}from"../chunks/CCxHhvyJ.js";import{b as v,f,c as R,t as X}from"../chunks/BawtTf_u.js";import{a as w,f as Z,e as W}from"../chunks/BZ8UElFc.js";import{e as H,i as z,c as ee,d as ne}from"../chunks/VJ--3aYi.js";import{e as te}from"../chunks/aJf7s6Jm.js";import{c as ae,b as se,i as oe}from"../chunks/DzQqPtxv.js";import{s as ie,p as j}from"../chunks/BlokMLgL.js";import{s as $}from"../chunks/DVIlHIMN.js";import{c as re,C as le,a as ce}from"../chunks/D9qCEIVy.js";import{b as ue}from"../chunks/D-RP1RH-.js";import"../chunks/HvopnIf4.js";var he=f('<section id="demo-link"><h2>Link</h2> <p><a href="elements">Default element styles demo</a></p> <p><a href="fonts">Pudding-hosted font previews</a></p> <p><a href="ui">BitsUI styled components</a></p></section>');function pe(i){var n=he();v(i,n)}var de=f('<section id="demo-image"><h2>Image</h2> <p>img tag</p> <img src="../assets/demo/test.jpg" alt="cat" class="svelte-b56t42"/> <p>background image</p> <div class="svelte-b56t42"></div></section>');function me(i){var n=de();v(i,n)}var ve=f('<section id="demo-element"><h2>Dynamic Svelte Element</h2> <!></section>');function ge(i){const n=[{tag:"h3",text:"I am a h3 tag."},{tag:"p",text:"I am p tag."}];var t=ve(),e=m(d(t),2);H(e,17,()=>n,z,(r,s)=>{let c=()=>l(s).tag,p=()=>l(s).text;var g=R(),a=D(g);te(a,c,!1,(o,u)=>{var y=X();_(()=>w(y,p())),v(u,y)}),v(r,g)}),h(t),v(i,t)}var fe=f("<p> </p>");function ye(i,n){var t=fe(),e=d(t);h(t),_(()=>w(e,`I am component A and my favorite number is ${n.number??""}.`)),v(i,t)}var be=f("<p> </p>");function we(i,n){var t=be(),e=d(t);h(t),_(()=>w(e,`I am component B and my name is ${n.name??""}.`)),v(i,t)}var xe=f('<section id="demo-component"><h2>Dynamic Svelte Component</h2> <!></section>');function ke(i){const n={A:ye,B:we},t=[{component:"A",number:42},{component:"B",name:"Russell"}];var e=xe(),r=m(d(e),2);H(r,17,()=>t,z,(s,c)=>{const p=B(()=>n[l(c).component]);var g=R(),a=D(g);ae(a,()=>l(p),(o,u)=>{u(o,ie(()=>l(c)))}),v(s,g)}),h(e),v(i,e)}var _e=f("<div><!></div>");function Ie(i,n){L(n,!0);let t=j(n,"root",3,null),e=j(n,"top",3,0),r=j(n,"bottom",3,0),s=j(n,"increments",3,100),c=j(n,"value",15,void 0),p=[],g=[],a=[],o=[],u;function y(){let b=0,k=0;for(let S=0;S<p.length;S++)p[S]>b&&(b=p[S],k=S);b>0?c(k):c(void 0)}function I(b,k){const S=P=>{P[0].isIntersecting;const V=P[0].intersectionRatio;p[k]=V,y()},G=e()?e()*-1:0,J=r()?r()*-1:0,N=`${G}px 0px ${J}px 0px`,U={root:t(),rootMargin:N,threshold:g};o[k]&&o[k].disconnect();const F=new IntersectionObserver(S,U);F.observe(b),o[k]=F}function A(){a.length&&a.forEach(I)}M(()=>{for(let b=0;b<s()+1;b++)g.push(b/s());a=u.querySelectorAll(":scope > *:not(iframe)"),A()}),M(()=>{e(),r(),A()});var x=_e(),C=d(x);$(C,()=>n.children??O),h(x),se(x,b=>u=b,()=>u),v(i,x),E()}var Se=f('<div><p class="svelte-1sxgmm9"> </p></div>'),qe=f('<section id="scrolly"><h2 class="svelte-1sxgmm9">Scrolly <span> </span></h2> <div class="spacer svelte-1sxgmm9"></div> <!> <div class="spacer svelte-1sxgmm9"></div></section>');function Ae(i){let n=T(void 0);var t=qe(),e=d(t),r=m(d(e)),s=d(r,!0);h(r),h(e);var c=m(e,4);Ie(c,{get value(){return l(n)},set value(p){q(n,p,!0)},children:(p,g)=>{var a=R(),o=D(a);H(o,16,()=>[0,1,2,3,4],z,(u,y,I)=>{const A=B(()=>l(n)===I);var x=Se();let C;var b=d(x),k=d(b,!0);h(b),h(x),_(()=>{C=ee(x,1,"step svelte-1sxgmm9",null,C,{active:l(A)}),w(k,y)}),v(u,x)}),v(p,a)},$$slots:{default:!0}}),Y(2),h(t),_(()=>w(s,l(n)||"-")),v(i,t)}const je=`{
  "meta": {
  ...
  "body": [
    ...
    },
    {
      ...
      "content": [
        ...
        {
          "type": "text",
          "value": "<span class=underline-vehicle>Cat</span> is a noun that is used to represent all sorts of different qualities. Writers use it to mean everything from <span class=underline-ground>graceful</span> to <span class=underline-ground>weak</span>."
        },
        {
          "type": "text",
...
}`;var Te=f('<p> </p> <progress max="100"></progress>',1);function Ce(i,n){let t=j(n,"label",3,"A"),e=j(n,"value",3,0);var r=Te(),s=D(r),c=d(s,!0);h(s);var p=m(s,2);_(()=>{w(c,t()),ne(p,e())}),v(i,r)}var De=f('<section id="cms"><h2>MicroCMS</h2> <code><pre> </pre></code> <!></section>');function Me(i,n){L(n,!0);const{body:t}=re,e={Test:Ce};var r=De(),s=m(d(r),2),c=d(s),p=d(c,!0);h(c),h(s);var g=m(s,2);le(g,{get components(){return e},get body(){return t}}),h(r),_(a=>w(p,a),[()=>je.replace(/\t/g," ")]),v(i,r),E()}const Be=(i,n=O)=>{var t=Le(),e=d(t),r=d(e,!0);h(e);var s=m(e,2),c=d(s,!0);h(s),h(t),_(()=>{w(r,n().name),w(c,n().age)}),v(i,t)};var Le=f('<div class="person svelte-q3gttf"><p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p></div>'),Ee=f('<h2>Svelte5</h2> <h3>Reactive variables 3 ways:</h3> <button class="svelte-q3gttf">count++</button> <p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p> <h3>Children (previously slots):</h3> <div class="children"><!></div> <h3>Dispatch Event</h3> <button class="svelte-q3gttf">Random</button>  <h3>Snippets</h3> <div class="people svelte-q3gttf"></div>',1);function He(i,n){L(n,!0),j(n,"age",3,30);const t=[{name:"John",age:30},{name:"Jill",age:45}];let e=T(0),r=B(()=>l(e)*2),s=B(()=>l(e)*2),c=T(0);M(()=>{q(c,l(e)*2)});var p=Ee(),g=m(D(p),4),a=m(g,2),o=d(a);h(a);var u=m(a,2),y=d(u);h(u);var I=m(u,2),A=d(I);h(I);var x=m(I,4),C=d(x);$(C,()=>n.children??O),h(x);var b=m(x,4),k=m(b,4);H(k,21,()=>t,z,(S,G)=>{Be(S,()=>l(G))}),h(k),_(()=>{w(o,`${l(e)??""} doubled is ${l(r)??""} (derived)`),w(y,`${l(e)??""} doubled is ${l(s)??""} (derived by)`),w(A,`${l(e)??""} doubled is ${l(c)??""} ($effect)`)}),W("click",g,()=>K(e)),W("click",b,()=>n.random(Math.floor(Math.random()*10))),v(i,p),E()}Z(["click"]);const ze=(i,n)=>{let t=T(Q(i)),e=T(null),r=T(!0),s=T(void 0);const c=(a=!0)=>{q(r,a,!0),a===!0&&(q(s,null),q(e,null))},p=async()=>{try{const a=await fetch(l(t),n);if(!a.ok)throw new Error(`Unexpected error occurred (status ${a.status})`);let o;if(l(t).includes(".csv")){const u=await a.text();o=ce(u)}else o=await a.json();return[null,o]}catch(a){const{errorMessage:o="Unexpected error eccurred"}=a;return[o,null]}},g=async a=>{c(!0);const[o,u]=await p();if(a===l(t)){if(o){c(!1),q(s,o,!0);return}c(!1),q(e,u,!0)}};return M(()=>{g(l(t))}),{get data(){return l(e)},get loading(){return l(r)},get error(){return l(s)},get url(){return l(t)},set url(a){l(t)!==a&&q(t,a,!0)}}};var Ge=f("<p>loading data...</p>"),Oe=f("<p> </p>"),Re=f("<p>data loaded</p> <pre> </pre>",1),Fe=f('<div class="c"><h2>Load Data</h2> <div class="response"><!></div></div>');function Pe(i,n){L(n,!0);const t=`${ue}/assets/demo/test.csv`,e=ze(t);M(()=>{});var r=Fe(),s=m(d(r),2),c=d(s);{var p=o=>{var u=Ge();v(o,u)},g=o=>{var u=Oe(),y=d(u);h(u),_(()=>w(y,`error: ${e.error??""}`)),v(o,u)},a=o=>{var u=Re(),y=m(D(u),2),I=d(y,!0);h(y),_(A=>w(I,A),[()=>JSON.stringify(e.data,null,2)]),v(o,u)};oe(c,o=>{e.loading?o(p):e.error?o(g,1):o(a,-1)})}h(s),h(r),v(i,r),E()}var We=f('<div id="demo" class="svelte-15aotx7"><h1>Demo</h1> <!> <!> <!> <!> <!> <!> <!> <!></div>');function $e(i){let n=T(0);function t(y){console.log(y)}var e=We(),r=m(d(e),2);pe(r);var s=m(r,2);me(s);var c=m(s,2);ge(c);var p=m(c,2);ke(p);var g=m(p,2);Me(g,{});var a=m(g,2);Pe(a,{});var o=m(a,2);Ae(o);var u=m(o,2);He(u,{random:t,get value(){return l(n)},set value(y){q(n,y,!0)}}),h(e),v(i,e)}function an(i){$e(i)}export{an as component};
