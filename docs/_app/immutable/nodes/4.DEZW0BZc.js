import"../chunks/DsnmJJEf.js";import{aq as p,$ as m,a1 as C,t as k,K as l,a0 as h,ar as E,Z as L,F as M,_ as B,a2 as z,M as q,aH as N,ag as T,bb as Y,L as Q}from"../chunks/B92FeS2C.js";import{b as v,f as g,c as F,t as Z}from"../chunks/BvRfo2l_.js";import{a as x,f as X,e as O}from"../chunks/BwpuD7DB.js";import{e as H,i as R,c as ee,d as te}from"../chunks/C2Vtx1Y2.js";import{e as ne}from"../chunks/DD47trRG.js";import{c as ae,b as se,i as oe}from"../chunks/DxeqRFj7.js";import{s as re,p as A}from"../chunks/C2wkIQ8G.js";import{s as P}from"../chunks/DGiPyN0h.js";import{c as ie,C as le,a as ce}from"../chunks/Djoda2Tw.js";import{b as ue}from"../chunks/a_a_Fgki.js";import"../chunks/HvopnIf4.js";var he=g('<section id="demo-link"><h2>Link</h2> <p><a href="elements">Default element styles demo</a></p> <p><a href="fonts">Pudding-hosted font previews</a></p> <p><a href="ui">BitsUI styled components</a></p></section>');function de(r){var t=he();v(r,t)}var me=g('<section id="demo-image"><h2>Image</h2> <p>img tag</p> <img src="../assets/demo/test.jpg" alt="cat" class="svelte-b56t42"/> <p>background image</p> <div class="svelte-b56t42"></div></section>');function pe(r){var t=me();v(r,t)}var ve=g('<section id="demo-element"><h2>Dynamic Svelte Element</h2> <!></section>');function fe(r){const t=[{tag:"h3",text:"I am a h3 tag."},{tag:"p",text:"I am p tag."}];var n=ve(),e=p(m(n),2);H(e,17,()=>t,R,(i,s)=>{let c=()=>l(s).tag,d=()=>l(s).text;var f=F(),a=C(f);ne(a,c,!1,(o,u)=>{var y=Z();k(()=>x(y,d())),v(u,y)}),v(i,f)}),h(n),v(r,n)}var ge=g("<p> </p>");function ye(r,t){var n=ge(),e=m(n);h(n),k(()=>x(e,`I am component A and my favorite number is ${t.number??""}.`)),v(r,n)}var be=g("<p> </p>");function xe(r,t){var n=be(),e=m(n);h(n),k(()=>x(e,`I am component B and my name is ${t.name??""}.`)),v(r,n)}var we=g('<section id="demo-component"><h2>Dynamic Svelte Component</h2> <!></section>');function _e(r){const t={A:ye,B:xe},n=[{component:"A",number:42},{component:"B",name:"Russell"}];var e=we(),i=p(m(e),2);H(i,17,()=>n,R,(s,c)=>{const d=E(()=>t[l(c).component]);var f=F(),a=C(f);ae(a,()=>l(d),(o,u)=>{u(o,re(()=>l(c)))}),v(s,f)}),h(e),v(r,e)}var ke=g("<div><!></div>");function Se(r,t){L(t,!0);let n=A(t,"root",3,null),e=A(t,"top",3,0),i=A(t,"bottom",3,0),s=A(t,"increments",3,100),c=A(t,"value",15,void 0),d=[],f=[],a=[],o=[],u;function y(){let b=0,_=0;for(let I=0;I<d.length;I++)d[I]>b&&(b=d[I],_=I);b>0?c(_):c(void 0)}function S(b,_){const I=J=>{J[0].isIntersecting;const K=J[0].intersectionRatio;d[_]=K,y()},$=e()?e()*-1:0,U=i()?i()*-1:0,V=`${$}px 0px ${U}px 0px`,W={root:n(),rootMargin:V,threshold:f};o[_]&&o[_].disconnect();const G=new IntersectionObserver(I,W);G.observe(b),o[_]=G}function j(){a.length&&a.forEach(S)}M(()=>{for(let b=0;b<s()+1;b++)f.push(b/s());a=u.querySelectorAll(":scope > *:not(iframe)"),j()}),M(()=>{e(),i(),j()});var w=ke(),D=m(w);P(D,()=>t.children??z),h(w),se(w,b=>u=b,()=>u),v(r,w),B()}var Ie=g('<div><p class="svelte-1sxgmm9"> </p></div>'),qe=g('<section id="scrolly"><h2 class="svelte-1sxgmm9">Scrolly <span> </span></h2> <div class="spacer svelte-1sxgmm9"></div> <!> <div class="spacer svelte-1sxgmm9"></div></section>');function je(r){let t=T(void 0);var n=qe(),e=m(n),i=p(m(e)),s=m(i,!0);h(i),h(e);var c=p(e,4);Se(c,{get value(){return l(t)},set value(d){q(t,d,!0)},children:(d,f)=>{var a=F(),o=C(a);H(o,16,()=>[0,1,2,3,4],R,(u,y,S)=>{const j=E(()=>l(t)===S);var w=Ie();let D;var b=m(w),_=m(b,!0);h(b),h(w),k(()=>{D=ee(w,1,"step svelte-1sxgmm9",null,D,{active:l(j)}),x(_,y)}),v(u,w)}),v(d,a)},$$slots:{default:!0}}),N(2),h(n),k(()=>x(s,l(t)||"-")),v(r,n)}const Ae=`{
  "meta": {
